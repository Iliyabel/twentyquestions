...
/** A text user interface for the 20 questions game. */
public class QuestionMain implements UserInterface {
    ...
    //Asking the user if want to save or load
    private void load() {
        print(LOAD_MESSAGE);
        if (nextBoolean()) {
            print(SAVE_FILENAME_MESSAGE);
    ...
    //asking the user if they want to save or load
    private void save() {
        print(SAVE_MESSAGE);
        if (nextBoolean()) {
            print(SAVE_FILENAME_MESSAGE);
